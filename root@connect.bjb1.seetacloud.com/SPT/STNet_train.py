...
def get_finetune_config():
    ...
    config_dict = {
        ...
        "finetune_data": { # Data specific to this fine-tuning task
            ...
            "train1_split_file": "contra_data_clean_noipad/fine_train_Ru copy 2.txt",
            "train2_split_file": "contra_data_clean_noipad/fine_train_Zr copy 2.txt",
        ...
        "spt_model_params": {
            ...
            'output_dim': 1024,           # Final projection dim if P_by_P_feature had one (otherwise transformer_dim)
        ...
        "optimizer": { "name": "AdamW", "lr": 0.0005, "weight_decay": 0.05 }, # LR for fine-tuning
        "finetune_scheduler": { # Scheduler for fine-tuning
            "name": "CosineAnnealingLR", "T_max": 37500, "eta_min": 1e-7
        },
        "training": {
            "max_iter": 300000, "log_freq": 50, "val_freq": 1000,
            "output_dir": "./STNet_test_v9_3abstraction_4class", # CHANGE THIS FOR DIFFERENT RUNS
            "clean_log_dir_on_start": True,
            "pretrained_backbone_checkpoint": "STNet_test_v8_3abstraction_4class/checkpoints/spt_latest.pth", # CRITICAL: Set actual path
